        ...
        <div class="mb-[30px] flex items-center justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">
              Request ID: <span class="font-semibold">{{ bookRequest.id }}</span>
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row gap-[30px]">
            ...
            <div class="flex-1 space-y-5">
              ...
              <div class="bg-[#f9f9f9] p-[20px] rounded-[12px]">
                <div class="bg-gradient-to-r from-[#b3e5fc] to-[#81d4fa]
                            px-[15px] py-[15px] rounded-[8px] font-semibold mb-[15px]">
                ...
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Name:</strong> {{ bookRequest.student_name }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Email:</strong> {{ bookRequest.student_email }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Student ID:</strong> N/A
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Program:</strong> N/A
                </p>
              </div>
              ...
              <div class="bg-[#f9f9f9] p-[20px] rounded-[12px]">
                ...
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Title:</strong> {{ bookRequest.book_title }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Author:</strong> {{ bookRequest.book_author }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Category:</strong> {{ bookRequest.book_category }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Year Published:</strong> {{ bookRequest.book_year }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">ISBN:</strong> {{ bookRequest.book_isbn }}
                </p>
              </div>
              ...
              <div class="bg-[#f9f9f9] p-[20px] rounded-[12px]">
                ...
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Chapter:</strong> {{ bookRequest.chapter }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Purpose:</strong> {{ bookRequest.purpose }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Needed By:</strong> {{ bookRequest.needed_by }}
                </p>
              </div>
              ...
              <div class="bg-[#f9f9f9] p-[20px] rounded-[12px]">
                ...
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Submitted:</strong> {{ bookRequest.submitted_at }}
                </p>
                <p class="mb-[6px] text-[14px] text-[#555]">
                  <strong class="text-[#333]">Current Status:</strong>
                  <span class="capitalize">{{ bookRequest.status }}</span>
                </p>
              </div>
              ...
              <form
                method="POST"
                :action="route('admin.requests.updateStatus', bookRequest.id)"
              ...
              >
                ...
                <div>
                  ...
                  <select name="status"
                    class="w-full px-[15px] py-[10px] border-2 border-[#a5d6a7]
                           rounded-[8px] text-[15px] outline-none cursor-pointer">
                    <option v-for="s in statuses" :key="s"
                            :value="s" :selected="bookRequest.status === s">
                      {{ capitalize(s) }}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <input type="date" name="expiration_at"
                         :value="bookRequest.expiration_at_raw"
                         class="w-full px-[12px] py-[10px] border-2 border-[#a5d6a7]
                                rounded-[8px] text-[14px] outline-none focus:border-[#66bb6a]" />
                </div>

                <!-- File Upload -->
                <div>
                  <h3 class="text-[16px] font-bold mb-[8px] text-[#2e7d32]">
                    Upload Digital Copy ❤️:
                  </h3>
                  <div class="px-[20px] py-[20px] border-2 border-dashed border-[#ccc]
                ...
                <div>
                  ...
                  <textarea name="note" rows="3"
                    class="w-full px-[12px] py-[12px] border-2 border-[#a5d6a7]
                           rounded-[8px] text-[14px] resize-y outline-none
                           focus:border-[#66bb6a]">{{ bookRequest.note }}</textarea>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-[12px] mt-[10px]">
                  ...
                  <button type="submit"
                    class="flex-1 px-[20px] py-[14px] rounded-[8px] text-[15px] font-semibold
                           bg-[#2e7d32] text-white hover:bg-[#1b5e20] transition-colors">
                    Save Changes
                  </button>
                </div>
              </form>
