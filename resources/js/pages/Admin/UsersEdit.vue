    ...
    <div class="flex min-h-[calc(100vh-60px)]">
      ...
      <main class="flex-1 px-[30px] py-[30px] bg-[#f5f5f5]">
        <div class="max-w-[800px] mx-auto bg-white rounded-[20px] p-[30px] shadow-[0_5px_20px_rgba(0,0,0,0.10)]">
          ...
          <!-- Errors -->
          <div v-if="editForm.errors && Object.keys(editForm.errors).length"
          ...
          <div class="space-y-[24px]">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-[20px]">
                ...
                <div>
                  ...
                  <input type="text" v-model="editForm.phone" placeholder="09XXXXXXXXX"
                         class="w-full rounded-[10px] border border-[#ddd] px-3 py-2 text-[14px] outline-none focus:border-[#4a90e2]" />
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-[20px] mt-[16px]">
                <div>
                  ...
                  <input type="text" v-model="editForm.course"
                         class="w-full rounded-[10px] border border-[#ddd] px-3 py-2 text-[14px] outline-none focus:border-[#4a90e2]" />
                </div>
                <div>
              ...
              <div class="mt-[16px]">
                ...
                <textarea v-model="editForm.address" rows="3" placeholder="Full residential address"
                          class="w-full rounded-[10px] border border-[#ddd] px-3 py-2 text-[14px] outline-none focus:border-[#4a90e2] resize-y"></textarea>
              </div>
            </div>
            ...
            <div class="flex gap-[10px] mt-[10px]">
              ...
              <button type="button" @click="submitEdit"
                ...
                class="inline-flex justify-center items-center px-[20px] py-[10px]
                       rounded-[8px] text-[14px] font-semibold bg-[#2e7d32] text-white hover:bg-[#1b5e20] disabled:opacity-60">
                {{ editForm.processing ? 'Saving...' : 'Save Changes' }}
              </button>
            </div>
          </div>

          <!-- ✅ Delete using Inertia router -->
          <div class="mt-[20px] border-t border-[#eee] pt-[20px]">
...
// ✅ Edit form - Inertia handles CSRF automatically
