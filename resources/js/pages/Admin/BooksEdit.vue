          ...
          <form method="POST" :action="route('admin.books.update', book.id)"
            ...
            <div class="grid grid-cols-1 md:grid-cols-[auto,1fr] gap-[24px] mb-[20px]">
              <div class="flex justify-center md:justify-start">
                <div class="w-[150px] h-[200px] bg-[#f5f5f5] border border-gray-300
                  ...
                  <img v-if="book.cover_url" :src="book.cover_url"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-[20px]">
              <div class="flex flex-col gap-[8px]">
                ...
                <input type="text" name="year_published" :value="book.year_published"
                       class="px-[12px] py-[12px] border-2 border-[#a5d6a7] rounded-[8px]
                              text-[15px] outline-none focus:border-[#66bb6a]" />
              </div>
              <div class="flex flex-col gap-[8px]">
            ...
            <div class="flex flex-col gap-[8px]">
              ...
              <textarea name="description" rows="4"
                        class="px-[12px] py-[12px] border-2 border-[#a5d6a7] rounded-[8px]
                               text-[14px] resize-y outline-none focus:border-[#66bb6a]">{{ book.description }}</textarea>
            </div>
            ...
            <div class="flex flex-col gap-[8px]">
              ...
              <textarea name="table_of_contents" rows="4" placeholder="Chapter 1 - Introduction"
                        class="px-[12px] py-[12px] border-2 border-[#a5d6a7] rounded-[8px]
                               text-[14px] resize-y outline-none focus:border-[#66bb6a]">{{ book.table_of_contents }}</textarea>
            </div>
