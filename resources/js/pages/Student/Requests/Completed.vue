              ...
              <tr v-for="req in requests" :key="req.id"
                ...
                <td class="px-4 py-3 text-center">
                  <div class="flex items-center justify-center gap-2">
                    ...
                    <a v-if="req.completed_file && !req.expired" :href="req.completed_file" target="_blank"
                       class="inline-flex px-3 py-1 rounded-full bg-blue-600 text-white text-xs font-semibold hover:bg-blue-700">Download</a>
                  </div>
                </td>
              </tr>
            </tbody>
