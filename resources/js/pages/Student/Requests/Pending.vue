    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
      ...
      <div class="mb-4 flex flex-wrap gap-2">
        ...
        <Link :href="route('student.requests.pending')"
           class="px-3 py-1 text-xs font-semibold rounded-full border bg-blue-600 text-white border-blue-600">Pending</Link>
          ...
          <table class="min-w-full text-sm border-collapse">
            ...
            <tbody>
              <tr v-if="requests.length === 0">
                <td colspan="6" class="px-4 py-6 text-center text-gray-500">No pending requests found.</td>
              </tr>
              <tr v-for="req in requests" :key="req.id"
                ...
                <td class="px-4 py-3">
                  <span class="inline-flex px-4 py-1 rounded-full text-xs font-semibold bg-[#fff3cd] text-[#856404]">Pending</span>
                </td>
