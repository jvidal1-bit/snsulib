  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
      ...
      <div class="mb-4 flex flex-wrap gap-2">
        <a :href="route('student.requests.index')"
           class="px-3 py-1 text-xs font-semibold rounded-full border bg-blue-600 text-white border-blue-600">
          All
        </a>
          ...
          <table class="min-w-full text-sm border-collapse">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-4 py-3">
                  <span
                    class="inline-flex px-4 py-1 rounded-full text-xs font-semibold"
                ...
                <td class="px-4 py-3 text-center">
                  <button
                    type="button"
                    class="text-xl leading-none bg-transparent border-0 cursor-pointer
        ...
        <div v-if="selected">
          ...
          <div v-if="selected.status === 'completed'" class="mb-6">
            ...
            <p class="text-sm text-gray-700 mb-1">
              <strong>Prepared By:</strong> {{ selected.prepared_by || '—' }}
            </p>
            <p class="text-sm text-gray-700 mb-3">
              <strong>Expires At:</strong> {{ selected.expiration_at || '—' }}
            </p>
            <a
              v-if="selected.completed_file && !selected.expired"
              :href="selected.completed_file"
              target="_blank"
              class="inline-flex px-4 py-2 rounded-full bg-blue-600 text-white
                     text-xs font-semibold hover:bg-blue-700"
            >
              Download File
            </a>
            <p v-if="selected.expired"
