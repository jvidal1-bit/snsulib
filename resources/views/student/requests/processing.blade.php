...
@section('title', 'Processing - SNSU Library E-Request')
...
@section('content')
    <div class="min-h-screen bg-gray-100" x-data="processingPage()">
        {{-- Navbar --}}
                        ...
                        <tbody>
                            @forelse($requests as $requestItem)
                                <tr class="border-b border-gray-200 hover:bg-gray-100 transition">
                                    ...
                                    <td class="px-4 py-3">
                                        {{-- processing badge style from CSS --}}
                                        <span class="inline-flex px-4 py-1 rounded-full text-xs font-semibold bg-[#cfe2ff] text-[#084298]">
                                            Processing
                                        </span>
                                    </td>
